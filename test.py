...
def name():
    win3 = GraphWin('Black Jack Rules', 300, 300)
    win3.setCoords(0, 0, 200, 200)
    theme = Image(Point(100,100),"BJTheme4.gif")
    theme.draw(win3)

    prompt = Text(Point(100, 150), 'Enter your name:')
    prompt.setSize(23)
    prompt.setTextColor('lemon chiffon')
    prompt.setFace('century')
    prompt.setStyle('bold')
    prompt.draw(win3)

    userInput = Entry(Point(100, 120), 20)
    userInput.draw(win3)
    button = Button(win3, Point(100, 75), 40, 15, 'Enter')
...
##            pass
    ...
    playerName = Text(Point(50, 75),str(userName) +':')
